...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_AFourDBlock_Statics::NewProp_vertices_Inner = { "vertices", nullptr, (EPropertyFlags)0x0000000000020000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FourDPoints, METADATA_PARAMS(0, nullptr) }; // 253099563
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_AFourDBlock_Statics::NewProp_vertices = { "vertices", nullptr, (EPropertyFlags)0x0010000000020001, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AFourDBlock, vertices), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_vertices_MetaData), NewProp_vertices_MetaData) }; // 253099563
const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_AFourDBlock_Statics::NewProp_transformMatrix = { "transformMatrix", nullptr, (EPropertyFlags)0x0010000000020001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AFourDBlock, transformMatrix), Z_Construct_UScriptStruct_FMatrix, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_transformMatrix_MetaData), NewProp_transformMatrix_MetaData) };
const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_AFourDBlock_Statics::NewProp_translation = { "translation", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AFourDBlock, translation), Z_Construct_UScriptStruct_FourDPoints, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_translation_MetaData), NewProp_translation_MetaData) }; // 253099563
const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_AFourDBlock_Statics::NewProp_rotation = { "rotation", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AFourDBlock, rotation), Z_Construct_UScriptStruct_FourDPlanes, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_rotation_MetaData), NewProp_rotation_MetaData) }; // 2628745566
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_AFourDBlock_Statics::NewProp_sliceWidth = { "sliceWidth", nullptr, (EPropertyFlags)0x0010000000020001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AFourDBlock, sliceWidth), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_sliceWidth_MetaData), NewProp_sliceWidth_MetaData) };
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AFourDBlock_Statics::NewProp_mesh = { "mesh", nullptr, (EPropertyFlags)0x00100000000a0009, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AFourDBlock, mesh), Z_Construct_UClass_UProceduralMeshComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_mesh_MetaData), NewProp_mesh_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AFourDBlock_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFourDBlock_Statics::NewProp_vertices_Inner,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFourDBlock_Statics::NewProp_vertices,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFourDBlock_Statics::NewProp_transformMatrix,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFourDBlock_Statics::NewProp_translation,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFourDBlock_Statics::NewProp_rotation,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFourDBlock_Statics::NewProp_sliceWidth,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFourDBlock_Statics::NewProp_mesh,
};
...
struct Z_CompiledInDeferFile_FID_Users_blakt_Documents_Unreal_Projects_4D_Playground_FourDSandbox_Source_FourDSandbox_FourDBlock_h_Statics
{
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FourDPoints::StaticStruct, Z_Construct_UScriptStruct_FourDPoints_Statics::NewStructOps, TEXT("ourDPoints"), &Z_Registration_Info_UScriptStruct_ourDPoints, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FourDPoints), 253099563U) },
		{ FourDPlanes::StaticStruct, Z_Construct_UScriptStruct_FourDPlanes_Statics::NewStructOps, TEXT("ourDPlanes"), &Z_Registration_Info_UScriptStruct_ourDPlanes, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FourDPlanes), 2628745566U) },
	};
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AFourDBlock, AFourDBlock::StaticClass, TEXT("AFourDBlock"), &Z_Registration_Info_UClass_AFourDBlock, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AFourDBlock), 751688324U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_blakt_Documents_Unreal_Projects_4D_Playground_FourDSandbox_Source_FourDSandbox_FourDBlock_h_1507013014(TEXT("/Script/FourDSandbox"),
	...
	Z_CompiledInDeferFile_FID_Users_blakt_Documents_Unreal_Projects_4D_Playground_FourDSandbox_Source_FourDSandbox_FourDBlock_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_blakt_Documents_Unreal_Projects_4D_Playground_FourDSandbox_Source_FourDSandbox_FourDBlock_h_Statics::ScriptStructInfo),
	nullptr, 0);
// End Registration
